...
const AvnerOvadStoreView = ({ store }: { store: Store }) => (
  <div className="min-h-screen bg-background font-heebo text-[#2f241d]">
    ...
    <main className="px-4 py-4">
      <div className="relative mx-auto max-w-[1400px] grid gap-4 md:grid-cols-[110px_1fr_110px] items-start">
        {/* Left column: 7 frames */}
        <div className="hidden md:flex flex-col gap-5 pt-4">
        ...
        <div className="flex flex-col items-center gap-6">
          <article className="relative z-10 w-full max-w-[720px] overflow-hidden rounded-[2rem] border border-[#d4c4a7] bg-[#f8f1e5] shadow-[0_24px_70px_rgba(66,44,20,0.16)]">
        ...
        <section className="relative z-10 grid gap-8 px-6 py-8 md:grid-cols-[1.1fr_0.9fr] md:px-10" dir="rtl">
          ...
          {/* Bottom row: 6 frames */}
          <div className="hidden md:grid grid-cols-6 gap-3 w-full max-w-[720px]">
