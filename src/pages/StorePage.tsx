      ...
      <div className="container mx-auto py-12 px-4">
        <div className={`${store.id === "s18" ? "max-w-[1400px]" : "max-w-4xl"} mx-auto`}>
          <div
            className={
              store.id === "s15"
                ? "rounded-[14px] border border-[#d5cabd] bg-[#f6f5ee] p-5 md:p-7 shadow-[0_2px_8px_rgba(105,88,64,0.12)] text-right"
          ...
          >
            {isIsraelMezuzahs ? (
              ...
              <div dir="rtl" className="grid gap-5 lg:grid-cols-[300px_minmax(0,1fr)]">
                {/* Row 1 - intro panel (right) + hero image (left) */}
                ...
                {/* Row 2 - products side panel (right) + 4 product frames (left) */}
                <section className="rounded-[10px] border border-[#d5cabd] bg-[radial-gradient(circle_at_50%_35%,rgba(232,225,207,0.58),transparent_43%),linear-gradient(135deg,#ddd4cd_0%,#e5ded9_100%)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.42),0_1px_2px_rgba(105,88,64,0.08)] text-right">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-[14px]">
                  {[tuliP1, tuliP2, tuliP3, tuliP4].map((src, i) => (
                    <article key={i} className="rounded-[9px] border border-[#d9cfbd] bg-[#f3eed8] p-[5px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.85),0_1px_2px_rgba(119,99,62,0.08)] flex">
                      <div className="w-full overflow-hidden rounded-[6px] shadow-[inset_0_1px_0_rgba(255,255,255,0.28)]">
                ...
                {/* Row 3 - workshops side panel (right) + 4 workshop frames (left) */}
                <section className="rounded-[10px] border border-[#d5cabd] bg-[radial-gradient(circle_at_50%_35%,rgba(232,225,207,0.58),transparent_43%),linear-gradient(135deg,#ddd4cd_0%,#e5ded9_100%)] p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.42),0_1px_2px_rgba(105,88,64,0.08)] text-right">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-[14px]">
                  {[
                    ...
                    <article key={i} className="overflow-hidden rounded-[9px] border border-[#d6cbbb] bg-[#f3edd7] shadow-[inset_0_1px_0_rgba(255,255,255,0.62),0_1px_2px_rgba(112,91,56,0.08)] flex flex-col h-full">
