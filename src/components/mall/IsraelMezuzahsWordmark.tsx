...
export const ISRAEL_MEZUZAHS_WORDMARK_PARAMETERS = {
  ...
  texture: {
    paperFibers:
      "radial-gradient(circle at 12% 22%, rgba(255,255,255,0.30) 0 1px, transparent 1.6px), radial-gradient(circle at 72% 34%, rgba(0,64,68,0.12) 0 1px, transparent 1.8px), radial-gradient(circle at 31% 76%, rgba(255,255,255,0.22) 0 0.8px, transparent 1.5px)",
    crossHatch:
      "linear-gradient(84deg, rgba(0,70,72,0.08) 0 1px, transparent 1px 7px), linear-gradient(176deg, rgba(255,255,255,0.16) 0 1px, transparent 1px 5px)",
    grainSize: "7px 7px, 11px 11px, 13px 13px, 5px 5px, 9px 9px",
  },
  title: {
...
const IsraelMezuzahsWordmark = ({ className, style, ...svgProps }: IsraelMezuzahsWordmarkProps) => {
  ...
  return (
    ...
    >
      ...
      <desc>
        Canvas {params.canvas.width}x{params.canvas.height}; teal background {params.canvas.background};
        crimson serif title {params.title.color}; white rounded subtitle {params.subtitle.color} with
        {params.subtitle.strokeWidth}px dark outline {params.subtitle.stroke}.
      </desc>
      <rect
