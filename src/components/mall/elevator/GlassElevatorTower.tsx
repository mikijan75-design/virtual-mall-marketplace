...
const FloorLanding = ({
  ...
  <div className="absolute left-[-48%] right-[-72%] z-30 h-[9%]" style={{ top }}>
    ...
    <div className="absolute z-[97] h-2 w-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500 shadow-[0_0_6px_rgba(249,115,22,0.9)] ring-1 ring-white/80" style={{ left: "8%", bottom: "49%" }} />
    ...
    <div className="absolute z-[97] h-2 w-2 translate-x-1/2 -translate-y-1/2 rounded-full bg-orange-500 shadow-[0_0_6px_rgba(249,115,22,0.9)] ring-1 ring-white/80" style={{ right: "4%", bottom: "49%" }} />
