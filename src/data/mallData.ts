...
export const mallFloors: Floor[] = [
  ...
  },
  {
    ...
    stores: [
      ...
      { id: "s4", name: "קוסמטיקה טבעית", floor: 3, position: 2, category: "קוסמטיקה", signColor: "from-rose-400 to-pink-600", logoEmoji: "🌸", description: "מוצרי טיפוח טבעיים" },
      ...
      { id: "s2", name: "טכנולוגיה מתקדמת", floor: 3, position: 4, category: "תשמישי קדושה", signColor: "from-cyan-400 to-blue-600", logoEmoji: "💻", description: "גאדג'טים וטכנולוגיה" },
      { id: "s5", name: "Guy Jana Art", floor: 3, position: 5, category: "אמנות", signColor: "from-amber-400 to-orange-600", logoEmoji: "🏺", description: "קרמיקה בעבודת יד" },
